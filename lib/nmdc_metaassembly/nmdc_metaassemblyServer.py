...
from nmdc_metaassembly.nmdc_metaassemblyImpl import nmdc_metaassembly  # noqa @IgnorePep8
impl_nmdc_metaassembly = nmdc_metaassembly(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_nmdc_metaassembly.run_nmdc_metaassembly,
                             ...
                             types=[dict])
        self.method_authentication['nmdc_metaassembly.run_nmdc_metaassembly'] = 'required'  # noqa
